function addWidgetsfrmBangunPagi() {
    ...
    var flxIsiKopi = new kony.ui.FlexContainer({
        "autogrowMode": kony.flex.AUTOGROW_NONE,
        "clipBounds": true,
        "height": "100%",
        "id": "flxIsiKopi",
    ...
    flxIsiKopi.setDefaultUnit(kony.flex.DP);
    ...
    flxKopi.add(flxGaris5, imgKopi, flxGaris6, btnKopi, flxOnOff3);
    ...
    flxIsiKopi.add(flxKopi, lblWaktuKopi);
    flxIsi1.add(flxIsiLampu, flxIsiAc, flxIsiKopi);
    flxIsi.add(flxIsi1);
