function addWidgetsfrmRuangDapur() {
    frmRuangDapur.setDefaultUnit(kony.flex.DP);
    ...
    Menu.btnBack.onClick = AS_Button_d432f2627fea434fbca5ff842b8eeac3;
    Menu.lblTitle.text = "Ruang Dapur";
    ...
    var imgRDapur = new kony.ui.Image2({
        "centerX": "50%",
        "centerY": "50%",
        "height": "180dp",
        "id": "imgRDapur",
    ...
    frmRuangDapur.add(flxMain);
};

function frmRuangDapurGlobals() {
    frmRuangDapur = new kony.ui.Form2({
        "addWidgets": addWidgetsfrmRuangDapur,
