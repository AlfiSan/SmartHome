function addWidgetsfrmRutinitasSiang() {
    frmRutinitasSiang.setDefaultUnit(kony.flex.DP);
    ...
    Menu.btnBack.onClick = AS_Button_jc1e9ace10234670824fd6d11f3d84c8;
    Menu.lblTitle.text = "Rutinitas Siang";
    ...
    var btnBangun = new kony.ui.Button({
        ...
        "isVisible": true,
        "left": "0dp",
        "onClick": AS_Button_jc35577ac9424171b12cc7d0de253892,
    ...
    frmRutinitasSiang.add(flxMain, Rutinitas);
};

function frmRutinitasSiangGlobals() {
    frmRutinitasSiang = new kony.ui.Form2({
        "addWidgets": addWidgetsfrmRutinitasSiang,
        "enabledForIdleTimeout": false,
        "id": "frmRutinitasSiang",
        "layoutType": kony.flex.FREE_FORM,
        "needAppMenu": false,
        "skin": "sknMerah"
    }, {
