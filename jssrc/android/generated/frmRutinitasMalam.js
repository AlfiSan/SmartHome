function addWidgetsfrmRutinitasMalam() {
    frmRutinitasMalam.setDefaultUnit(kony.flex.DP);
    ...
    Menu.btnBack.onClick = AS_Button_c7f2ca9b5cda427dbab3718a4c801a65;
    Menu.lblTitle.text = "Rutinitas Malam";
    ...
    var btnBangun = new kony.ui.Button({
        ...
        "isVisible": true,
        "left": "0dp",
        "onClick": AS_Button_fa5c4373d3cb48ec93734e3ac4355711,
    ...
    frmRutinitasMalam.add(flxMain, Rutinitas);
};

function frmRutinitasMalamGlobals() {
    frmRutinitasMalam = new kony.ui.Form2({
        "addWidgets": addWidgetsfrmRutinitasMalam,
        "enabledForIdleTimeout": false,
        "id": "frmRutinitasMalam",
        "layoutType": kony.flex.FREE_FORM,
        "needAppMenu": false,
        "skin": "sknMerah"
    }, {
