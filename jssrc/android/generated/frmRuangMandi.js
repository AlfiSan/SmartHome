function addWidgetsfrmRuangMandi() {
    frmRuangMandi.setDefaultUnit(kony.flex.DP);
    ...
    Menu.btnBack.onClick = AS_Button_e14945501370402ab248e819364a6580;
    Menu.lblTitle.text = "Kamar Mandi";
    ...
    var imgKmandi = new kony.ui.Image2({
        "centerX": "50%",
        "centerY": "50%",
        "height": "180dp",
        "id": "imgKmandi",
    ...
    frmRuangMandi.add(flxMain);
};

function frmRuangMandiGlobals() {
    frmRuangMandi = new kony.ui.Form2({
        "addWidgets": addWidgetsfrmRuangMandi,
