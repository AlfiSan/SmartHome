function addWidgetsfrmBangunPagi() {
    frmBangunPagi.setDefaultUnit(kony.flex.DP);
    ...
    Menu.btnBack.onClick = AS_Button_j30ce38a62694cedaf591525494d65e8;
    Menu.lblTitle.text = "Bangun Pagi";
    ...
    var imgBangunPagi = new kony.ui.Image2({
        "centerX": "50%",
        "centerY": "50%",
        "height": "180dp",
        "id": "imgBangunPagi",
    ...
    var flxIsiJendela = new kony.ui.FlexContainer({
        "autogrowMode": kony.flex.AUTOGROW_NONE,
        "clipBounds": true,
        "height": "100%",
        "id": "flxIsiJendela",
    ...
    flxIsiJendela.setDefaultUnit(kony.flex.DP);
    ...
    flxJendela.add(flxGaris5, imgTV, flxGaris6, btnJendela, flxOnOff3);
    ...
    flxIsiJendela.add(flxJendela, lblWaktuKopi);
    flxIsi1.add(flxIsiLampu, flxIsiAc, flxIsiJendela);
    flxList.add(flxIsi1);
    flxIsi.add(flxImage, flxList);
    flxMain.add(Menu, Rutinitas, flxIsi);
    frmBangunPagi.add(flxMain);
};

function frmBangunPagiGlobals() {
    frmBangunPagi = new kony.ui.Form2({
        "addWidgets": addWidgetsfrmBangunPagi,
