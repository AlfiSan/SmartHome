function addWidgetsfrmRuangTidur() {
    frmRuangTidur.setDefaultUnit(kony.flex.DP);
    ...
    Menu.lblTitle.text = "Ruang Tidur";
    ...
    frmRuangTidur.add(flxMain);
};

function frmRuangTidurGlobals() {
    frmRuangTidur = new kony.ui.Form2({
        "addWidgets": addWidgetsfrmRuangTidur,
