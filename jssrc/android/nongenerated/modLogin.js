...
function loginUser(username, password) {
    ...
    if (result) {
        ...
        if (tknsts === "old") {
            getTokenModegi(username, password);
        }
...
function getTokenModegi(username, password) {
    ...
    var headers = {
        "Authorization": "Basic " + loguserpass
    };
    var data = {};
    ...
    kony.application.showLoadingScreen("loadskin", "Loading Please Wait...", constants.LOADING_SCREEN_POSITION_FULL_SCREEN, false, true, {
        enableMenuKey: true,
        enableBackKey: true,
